  ...
  return (
    <ProductProvider>
      ...
      <div className={styles.productPage}>
        ...
        {/* Use custom images for carousel if slug is 2007-997-1-gt3rs */}
        {params.handle === "2007-997-1-gt3rs" ? (
          <ImageCarousel
            images={[
              {
                id: 1,
                src: "/images/carousel/car/1.png",
                alt: "Car image 1",
              },
              {
                id: 2,
                src: "/images/carousel/car/2.png",
                alt: "Car image 2",
              },
              {
                id: 3,
                src: "/images/carousel/car/3.png",
                alt: "Car image 3",
              },
            ]}
          />
